...
// Implementation of mpiCheckProbablePrime
__weak_func error_t mpiCheckProbablePrime(const Mpi *a) {
    ...
    /* k= 2 for bit lengths over 1300 in openssl http://docs.huihoo.com/doxygen/openssl/1.0.1c/crypto_2bn_2bn_8h_source.html#l00384 */
    uint_t k = 4;
    error_t error;
    error = isProbablePrime(a, k, YARROW_PRNG_ALGO, &prngcontext);
