...
void small_ntt_asm(int16_t a[N1], const int16_t * zetas);
void small_invntt_tomont_asm(int16_t a[N1], const int16_t * zetas);
void small_pointmul_asm(int16_t out[N1], const int16_t in[N1], const int16_t *zetas);
